 ...
 * 
 */
@WebServiceClient(name = "CalcPrecoPrazoWS", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/home/bira/git/ubirailson/webservices-jaxws/correios-cliente/src/CalcPrecoPrazo.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/bira/git/ubirailson/webservices-jaxws/correios-cliente/src/CalcPrecoPrazo.wsdl");
